  ...
  try {
    ...
    if (!data.exists) {
      ...
      const reason = suggestedName
        ? `No se encontr� coincidencia exacta en el Exequ�tur del SNS. Nombre similar encontrado: ${suggestedName}. Verifica el nombre completo tal como aparece en el SNS.`
        : "Este m�dico no aparece en el Exequ�tur del SNS. Verifica el nombre completo tal como aparece en el SNS.";
