...
const translations: Record<AppLanguage, Record<TranslationKey, string>> = {
  es: {
    ...
    'config.title': 'Configuracion del Sistema',
    'config.subtitle': 'Gestiona tu cuenta, notificaciones, privacidad y preferencias del portal medico.',
    'config.account': 'Configuracion de Cuenta',
    'config.accountHint': 'Personaliza tu experiencia basica',
    ...
    'config.notificationsHint': 'Elige como quieres recibir alertas',
    'config.email': 'Correo electronico',
    ...
    'config.securityHint': 'Protege tu informacion medica',
    'config.changePassword': 'Cambiar Contrasena',
    'config.sessionHistory': 'Historial de Sesiones',
    'config.support': 'Soporte y Ayuda',
    'config.supportHint': 'Estamos aqui para ayudarte',
    'config.needHelp': 'Necesitas asistencia?',
    'config.supportText': 'Nuestro equipo tecnico esta disponible 24/7 para cualquier inconveniente con la plataforma.',
    'config.contact': 'Contactar',
    'config.faq': 'FAQs',
    'config.systemVersion': 'Version del sistema: VIREM v2.4.1',
