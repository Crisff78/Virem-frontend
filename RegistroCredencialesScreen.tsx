...
import { Alert, Dimensions, ScrollView, StyleSheet, Text, TextInput, TouchableOpacity, View, ActivityIndicator } from 'react-native';
...
const RegistroCredencialesScreen: React.FC = () => {
    ...
    const handleFinish = async () => {
        ...
        try {
            ...
            // CONEXIÓN CON TU IP CONFIGURADA
            ...
            Alert.alert("Error de Red", "No se pudo conectar al servidor en 10.0.0.135. Verifique que el servidor esté encendido.");
        } finally {
            setIsLoading(false);
        }
    };
            ...
            <View style={styles.header}>
                <View style={styles.headerContent}>
                    <View style={styles.logoGroup}>
                        <View style={styles.logoIconPlaceholder}><MaterialIcons name="medical-services" size={24} color={colors.primary} /></View>
            ...
            <ScrollView contentContainerStyle={{ paddingBottom: 40 }}>
                <View style={styles.contentWrapper}>
                    ...
                    <View style={styles.formCard}>
                        ...
                        <Text style={styles.cardSubtitle}>Hola {route.params.datosPersonales.nombres}, crea tu cuenta para acceder.</Text>

                        <View style={styles.inputGroup}>
                            <Text style={styles.label}>Correo Electrónico</Text>
                            <View style={styles.inputContainer}>
                                <MaterialIcons name="email" size={20} color={colors.blueGray} style={{ marginRight: 10 }} />
                                <TextInput style={styles.textInput} placeholder="nombre@correo.com" value={email} onChangeText={setEmail} keyboardType="email-address" autoCapitalize="none" />
                            </View>
                        </View>
                        ...
                        <View style={styles.inputGroup}>
                            ...
                            <View style={styles.inputContainer}>
                                ...
                                <TextInput style={styles.textInput} placeholder="••••••••" value={password} onChangeText={setPassword} secureTextEntry={secureText} />
                                <TouchableOpacity onPress={() => setSecureText(!secureText)}><MaterialIcons name={secureText ? "visibility" : "visibility-off"} size={20} color={colors.blueGray} /></TouchableOpacity>
                            </View>
                        </View>
                        ...
                        <View style={styles.inputGroup}>
                            ...
                            <View style={styles.inputContainer}>
                                <MaterialIcons name="lock" size={20} color={colors.blueGray} style={{ marginRight: 10 }} />
                                <TextInput style={styles.textInput} placeholder="••••••••" value={confirmPassword} onChangeText={setConfirmPassword} secureTextEntry={secureText} />
                            </View>
                        </View>
                        ...
                        <TouchableOpacity style={styles.btnBack} onPress={() => navigation.goBack()}><Text style={styles.btnBackText}>Volver</Text></TouchableOpacity>
                    </View>
                </View>
            </ScrollView>
        </View>
...
const styles = StyleSheet.create({
    ...
    header: { height: 70, backgroundColor: 'white', borderBottomWidth: 1, borderBottomColor: '#eee', justifyContent: 'center', paddingHorizontal: 20 },
    headerContent: { flexDirection: 'row', alignItems: 'center' },
    logoGroup: { flexDirection: 'row', alignItems: 'center', gap: 10 },
    logoIconPlaceholder: { width: 40, height: 40, backgroundColor: '#e8f2fe', borderRadius: 10, justifyContent: 'center', alignItems: 'center' },
    ...
    inputContainer: { flexDirection: 'row', alignItems: 'center', borderWidth: 1, borderColor: '#cbd5e1', borderRadius: 10, paddingHorizontal: 12, height: 50, backgroundColor: colors.slate50 },
